    ...
    public String login(Model model, @RequestParam("username") String username,
        ...
        try {
			...
			if(map.containsKey("ticket")) {
				...
				response.addCookie(cookie);
			    EventModel model2 = new EventModel(EventType.LOGIN).setActorId((int) map.get("userId"))
						.setExt("username","牛客X").setExt("email", "casesc@163.com");
			    eventProducer.fireEvent(model2);
